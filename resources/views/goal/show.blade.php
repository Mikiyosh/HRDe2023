...
<tbody>
  ...
  <tr class="hover:bg-gray-lighter">
    <td class="py-4 px-6 border-b border-gray-light dark:border-gray-600">
      <x-input-label for="leadership1" :value="__('全社目標')" class="custom-leadership-style text-left" />    
...
<tbody>
  ...
  <tr class="hover:bg-gray-lighter">
    <td class="py-4 px-6 border-b border-gray-light dark:border-gray-600">
      <x-input-label for="leadership1" :value="__('部門目標')" class="custom-leadership-style text-left" />    
...
<tbody>
  ...
  <tr class="hover:bg-gray-lighter">
    <td class="py-4 px-6 border-b border-gray-light dark:border-gray-600">
      <x-input-label for="leadership1" :value="__('個人目標')" class="custom-leadership-style text-left" />    
